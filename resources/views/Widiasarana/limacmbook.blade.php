...
@section('container')
    ...
    <body>
        ...
        <div class="card mb-3 align-items-center">
            <img src="../5cm.jpg" class="card-img-top" alt="5cm : Aku, Kamu, Samudera, dan Bintang Bintang">
            <div class="card-body">
                <h5 class="card-title">5cm : Aku, Kamu, Samudera, dan Bintang Bintang</h5>
                <p class="card-text">Author : Donny Dhirgantoro</p>
                <p class="card-text">Publisher : Gramedia Widiasarana Indonesia</p>
                <p class="card-text">Year : 2020</p>
                <p class="card-text">Synopsis : <br>
                    Ia di sini sekarang, perjalanan pulang setelah Mahameru—Perjalanan Hati—puncak tertinggi Jawa, dan
